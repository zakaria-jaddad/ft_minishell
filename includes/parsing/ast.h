...
/*   Updated: 2025/06/20 08:18:53 by zajaddad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void	print_cmd(t_cmd *root, int depth)
{
	...
	if (depth == 0)
        ...
        if (is_node_redirection(root->type) == true)
        {
                ...
                t_cmd_redir *redir = (t_cmd_redir*) root->content;
        ...
        {
                t_cmd_simple *simple_command = (t_cmd_simple *) root->content;
                print_depth(depth + 3);
